...
import AnalysisCreditsBadge, { computeAnalysisCredits } from "@/components/dashboard/AnalysisCreditsBadge";
    ...
    <div className="min-h-screen p-6 md:p-10 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-outline-variant">
        ...
        <div className="flex items-center gap-3 self-start md:self-auto flex-wrap">
          {/* Analysis Credits Badge (5 credits total, 1 used per analyzed repo) */}
          <AnalysisCreditsBadge repos={repos} />
          ...
          {creditsRemaining <= 0 ? (
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-xl text-on-primary bg-primary-accent hover:opacity-90 transition-all cursor-pointer shadow-md"
            >
              <Plus size={13} />
              New Repo
            </Link>
